    ...
    <div class="space-y-6">
      ...
      <div>
        ...
        <div v-else-if="selectedPaymentMethodId === 'new' && newCardForm.card_number"
          ...
          <div>
            <p class="text-gray-900 font-medium">
              {{ detectCardType(newCardForm.card_number) }} ending in {{ newCardForm.card_number.replace(/\s/g, '').slice(-4) }}
            </p>
            <p class="text-sm text-gray-600">
      ...
      <div class="flex space-x-4">
        ...
        <BaseButton @click="$emit('placeOrder')" :loading="isPlacingOrder" :disabled="isPlacingOrder" variant="success"
