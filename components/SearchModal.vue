        ...
        <div class="relative flex min-h-full items-start justify-center p-4 pt-16 sm:pt-24" @click="$emit('close')">
          ...
          >
            ...
            >
              ...
              <!-- Live Search Results -->
              <div v-if="localSearchQuery && localSearchQuery.length > 1" class="border-t border-gray-100 bg-white">
                <div class="p-6">
                  ...
                  <div v-else-if="searchResults.length > 0" class="space-y-1">
                    <button 
                      ...
                      class="w-full flex items-center p-3 rounded-lg cursor-pointer transition-colors text-left focus:outline-none"
