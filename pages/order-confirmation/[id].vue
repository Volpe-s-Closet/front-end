  ...
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div v-else-if="error" class="text-center py-12">
      <div class="bg-red-50 border border-red-200 rounded-lg p-6">
        ...
        <NuxtLink to="/" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
          Return to Home
        </NuxtLink>
      </div>
    </div>
    ...
    <div v-else-if="order" class="space-y-8">
      ...
      <div class="text-center bg-green-50 border border-green-200 rounded-lg p-8">
        ...
        <p class="text-green-700 mb-4">Thank you for your purchase. Your order has been received and is being processed.</p>
      ...
      <div class="bg-white border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div class="p-6 space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wide mb-2">Order Information</h3>
              <dl class="space-y-2">
                ...
                <div class="flex justify-between">
                  ...
                  <dd class="text-sm font-medium text-gray-900">{{ formatDate(order.date_created) }}</dd>
                </div>
                <div class="flex justify-between">
                ...
                <div class="flex justify-between">
                  ...
                  <dd class="text-sm font-medium text-gray-900">${{ parseFloat(order.total).toFixed(2) }}</dd>
                </div>
              </dl>
            </div>
            ...
            <div>
              ...
              <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wide mb-2 mt-4">Shipping Address</h3>
          ...
          <div class="border-t border-gray-200 pt-6">
            <div class="space-y-2">
              ...
              <div v-if="order.shipping_lines && order.shipping_lines.length > 0" class="flex justify-between text-sm">
                <span class="text-gray-600">Shipping:</span>
                <span class="text-gray-900">${{ parseFloat(order.shipping_lines[0].total).toFixed(2) }}</span>
              </div>
              <div v-if="order.total_tax && parseFloat(order.total_tax) > 0" class="flex justify-between text-sm">
