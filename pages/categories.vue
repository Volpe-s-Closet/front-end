    ...
    <div v-else-if="filteredCategories.length > 0"
      ...
      <div v-for="category in filteredCategories" :key="category.id"
        ...
        <div class="relative h-48 bg-gradient-to-br from-blue-100 to-purple-100">
          ...
          <!-- Product count badge -->
          <div
            class="absolute top-2 right-2 bg-white bg-opacity-90 text-gray-700 px-2 py-1 rounded-full text-xs font-medium">
        ...
        <div class="p-6">
          ...
          <div v-if="category.children?.length > 0" class="mb-4">
            ...
            <div class="flex flex-wrap gap-1">
              <NuxtLink v-for="child in category.children.slice(0, 3)" :key="child.id" :to="`/category/${child.slug}`"
